 ...
 * `dll_inject_shellcode.cpp`/`dll_inject_shellcode.h` &minus; A shellcode used by `kforge_example.exe` to handle injected DLL image imports and do other things.
